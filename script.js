alert("Try to draw something on the screen & see magic...")
window.onload = function(){
 ...
  var drawing = false;
	...
	function drawOthersAlt(x,y,r,t,n){
		var p1 = getPoint(pointXE,pointYAE,r,t,n);
		var p2 = getPoint(pointX,pointYA,r,t,n);
		var p3 = getPoint(x,y,r,t,n);
		ctx.beginPath();
	...
	function drawOthers(x,y,r,t,n){
		var p1 = getPoint(pointXE,pointYE,r,t,n);
		var p2 = getPoint(pointX,pointY,r,t,n);
		var p3 = getPoint(x,y,r,t,n);
		ctx.beginPath();
		ctx.moveTo(p1[0],p1[1]+1);
		ctx.lineTo(p2[0],p2[1]);
